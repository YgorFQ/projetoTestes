      ...
      <div class="faq-test-layout">
        <aside class="faq-test-sidebar" aria-label="Edição do FAQ">
          ...
          <nav class="faq-test-workflow" role="tablist" aria-label="Área de trabalho">
            <button class="faq-test-workflow__tab is-active" id="faq-test-tab-editor" type="button" role="tab" aria-controls="faq-test-panel-editor" aria-selected="true" data-workspace-tab="editor">Editar FAQ</button>
            <button class="faq-test-workflow__tab" id="faq-test-tab-output" type="button" role="tab" aria-controls="faq-test-panel-output" aria-selected="false" data-workspace-tab="output">Código final</button>
          </nav>
              ...
              <div class="faq-test-question-section">
                <div class="faq-test-question-section__head">
                  ...
                  <div class="faq-test-actions faq-test-actions--compact">
                    ...
                    <button class="faq-test-btn faq-test-btn--primary" id="faq-test-add-pair" type="button">+ Pergunta</button>
                  </div>
                </div>
