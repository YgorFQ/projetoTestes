(function () {
  ...
  function appendStyles(root) {
    ...
    sharedStylesheet.href = featureUrl('../../shared/styles/senko-components.css?v=20260923-faq-test-14');
    root.appendChild(sharedStylesheet);

    var stylesheet = document.createElement('link');
    stylesheet.rel = 'stylesheet';
    stylesheet.href = featureUrl('styles.css?v=20260923-faq-test-14');
  ...
  function loadPanel() {
    ...
    loadPromise = (async function () {
      await loadScript('core.js?v=20260923-faq-test-14');
      await loadScript('view.js?v=20260923-faq-test-14');
      var content = window.SenkoFaqTest.createView();
      shadow.appendChild(content);
      await loadScript('script.js?v=20260923-faq-test-14');
