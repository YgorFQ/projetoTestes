...
/* ═══════════════════════════════════════════════════════════════════════
   ...
   FUNCIONALIDADES:
     ...
     - Remove o objeto do arquivo em legacy/biblioteca/data/layouts
...
/* ═══════════════════════════════════════════════════════════════════════
   ...
   deleteVariants = true  → também apaga o arquivo de variantes da Biblioteca
═══════════════════════════════════════════════════════════════════════ */
    ...
    return githubGetFile(manifestEntry.path).then(function (data) {
      ...
      return ghDeleteFile(
        ...
        if (typeof ghStartDeployWatch === 'function') {
          ghStartDeployWatch('legacy/biblioteca/data/manifest.js');
        }
        renderGrid();
        return true;
      });
