...
const accessRegister = fs.readFileSync(path.join(root, 'app/tools/access/register.js'), 'utf8');
const utilityMenu = fs.readFileSync(path.join(root, 'app/shell/scripts/senko-utility-menu.js'), 'utf8');
const accessCss = fs.readFileSync(path.join(root, 'app/tools/access/styles/access.css'), 'utf8');
