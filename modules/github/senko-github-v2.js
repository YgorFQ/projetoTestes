...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (function () {
    ...
    cfgStyle.textContent = [
      ...
      '}',
      /* ─── Tema escuro ─── */
      '[data-theme="dark"] #ghConfigOverlay > div {',
      ...
      '}',
      '[data-theme="dark"] .gh-config-field input::placeholder {',
      '  color: var(--text3, #475569);',
      '}',
      '[data-theme="dark"] .gh-config-field input:focus {',
      '  border-color: #64748b;',
      '}',
      '[data-theme="dark"] .gh-config-field label {',
      '  color: var(--text1, #e2e8f0);',
      '}',
      '[data-theme="dark"] #ghConfigOverlay h3 {',
      '  color: var(--text1, #e2e8f0);',
      '}',
      '[data-theme="dark"] #ghConfigOverlay p {',
      '  color: var(--text2, #94a3b8);',
      '}',
      '[data-theme="dark"] #ghConfigCloseBtn {',
      '  color: var(--text3, #64748b);',
      '}',
      '[data-theme="dark"] #ghConfigCloseBtn:hover {',
      '  color: var(--text1, #e2e8f0);',
      '}',
      '[data-theme="dark"] .gh-field-desc code {',
      '  background: var(--hover, #1e293b);',
      '  color: var(--text2, #94a3b8);',
      '}',
      '[data-theme="dark"] .gh-config-gear-btn {',
      '  background: var(--card, #1e293b);',
      '  border-color: var(--border, #334155);',
      '  color: var(--text3, #94a3b8);',
      '}',
      '[data-theme="dark"] .gh-config-gear-btn:hover {',
      '  background: var(--hover, #0f172a);',
      '  border-color: var(--text3, #64748b);',
      '}',
    ].join('\n');
